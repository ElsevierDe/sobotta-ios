...
{   
    return (__bridge KKGridViewUpdate *) (CFDictionaryGetValue(_availableUpdates, (__bridge void *) indexPath));
}

- (BOOL)hasUpdateForIndexPath:(KKIndexPath *)indexPath
{
    KKGridViewUpdate *update = (__bridge KKGridViewUpdate *) CFDictionaryGetValue(_availableUpdates, (__bridge void *) indexPath);
